...
# --- MOSTRAR TICKET ---
  mostrar_ticket(producto, precio, cantidad, total)
...
def abrir_reportes():
    ...
    lbl_total_general.pack(pady=15)
...
def abrir_acerca_de():
    texto = (
        "PUNTO DE VENTA - ROPA\n"
        "Versión 1.0\n\n"
        "Este programa permite gestionar un pequeño sistema de ventas.\n\n"
        "Funciones principales:\n"
        "• Registrar productos con su precio y categoría.\n"
        "• Registrar ventas seleccionando productos existentes.\n"
        "• Generar tickets de venta automáticamente.\n"
        "• Consultar un reporte completo de todas las ventas.\n"
        "• Calcular el total general vendido.\n\n"
        "Aplicación creada como proyecto escolar."
    )
...
# -------------------------
estilo = ttk.Style()
estilo.configure("TButton", font=("Arial", 12), padding=10, background="black", foreground="white")
...
btn_reg_prod = tk.Button(ventana, text="Registro de Productos", command=abrir_registro_productos, bg="black", fg="white", font=("Arial", 12), relief="flat")
